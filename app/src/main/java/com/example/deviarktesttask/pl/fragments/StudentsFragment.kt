...
class StudentsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val students = bundle?.getParcelableArrayList<Character>("CHARACTERS")
        val adapter = CharactersAdapter(students!!.toList())
        val view = inflater.inflate(R.layout.fragment_students, container, false)
        val studentsRecyclerView = view.findViewById<RecyclerView>(R.id.students_recyclerview)
        studentsRecyclerView.layoutManager = LinearLayoutManager(view.context)
