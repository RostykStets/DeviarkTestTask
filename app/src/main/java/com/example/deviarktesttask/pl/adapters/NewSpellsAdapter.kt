...
import com.example.deviarktesttask.pl.dialogs.NewSpellDialog

class NewSpellsAdapter(private val context: Context, private val spells: List<Spell>, private val characterId: String):
    RecyclerView.Adapter<NewSpellsAdapter.ViewHolder>() {
    ...
    private fun onItemClick(spell: Spell){
        val dialog = NewSpellDialog(context, spell, characterId)
        dialog.show()
    }
}